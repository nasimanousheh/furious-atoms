...
DEAULT_HEADER = "LAMMPS data file. Created by FURIOUS ATOMS. By default the box dimensions are 90x90x90 cubic angstrom\n"
...
class LAMMPSSaver(BaseSaver):
    ...
    def write_all_atoms(self, new_fp, old_fp, structure):
        ...
        while True:
            ...
            if not self.is_atom_deleted(atom_id):            
                ...
                new_fp.write(ATOM_FORMAT%(self.atom_serial, typ, x, y, z))
                self.atom_serial += 1
                self.saved_atom_ids[i] = 1
            i += 1
    ...
    def write_all_bonds(self, new_fp, old_fp, structure):
        ...
        while True:
            ...
            bond = self.corrected_bonds[i]
            if not self.is_bond_deleted(i):
                atom1, atom2 = bond + 1
                bond_type = words[1]
                new_fp.write("%d %s %d %d\n"%(bond_serial, bond_type, atom1, atom2))
                bond_serial += 1
            i += 1
        new_fp.write("\n")
...
if __name__ == "__main__":
    ...
    # INPUT_FNAME = "C:\\Users\\Pete\\Desktop\\furious-atoms-exercises\\Graphdiyne\\graphdiyne_unitcell.data"
    # INPUT_FNAME = "C:\\Users\\Pete\\Desktop\\furious-atoms-exercises\\WaterProtein\\water_protein.data"
