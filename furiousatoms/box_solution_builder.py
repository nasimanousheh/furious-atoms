...
class Ui_box_water(QtWidgets.QMainWindow): #QWidget
    ...
    def create_connections(self):
        ...
        self.box_water.pushButton_build_Solution.clicked.connect(self.water_builder_callback)
    ...
    def water_builder_callback(self):
        active_window = self.win.active_mdi_child()
        SM = active_window.universe_manager
        ...
        # merge.select_atoms('same resid as (not around 30 MOL)')
        # file_name = 'C:/Users/nasim/OneDrive/Desktop/cnvert/sol_water.pdb'
        # merge.atoms.write(file_name)
        SM = active_window.universe_manager
